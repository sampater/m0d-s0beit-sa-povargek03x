...
#define SAMP_PLAYER_MAX				1004 //fuck
...
//806B0
#define SAMP_CHAT_INFO_OFFSET   0x212A24//20DFD8 (by Sapas)
#define SAMP_CHAT_INPUT_INFO_OFFSET  0x212A28//20DFDC (by Sapas)
#define SAMP_KILL_INFO_OFFSET   0x212A2C//20DFE0 (by Sapas)
#define SAMP_INFO_OFFSET    0x212A38//20DFEC (by Sapas)

#define SAMP_COLOR_OFFSET    0x1FA348//20AE78 (by Sapas)
#define VALUE_DRAWING_DISTANCE   0xCDCEC//C9CA8 (by Sapas)

//new
#define SAMP_WARNING_COUNT    0x10B8E0// (by povargek)
...
#define SAMP_SCOREBOARD_INFO   0x2129F4//20DFA8 (by Sapas)
#define SAMP_GAMEPROCESSHOOK   0x6550A//9783A (by Sapas)
#define SAMP_FUNCUPDATESCOREBOARDDATA 0x7D50//0x76C0 (by FYP)
...
extern RakClientInterface *raknet;
