...
static struct patch_set patch_actor_hp2 =
{
	"by povargek",
	0,
	0,
	// Parachute Death
	{ { 7, (void *)0x0096916D, NULL, (uint8_t *)"\xB8\x00\x00\x00\x00\xC3\x90", NULL } }
};
static struct patch_set patch_actor_hp3 =
{
	"by povargek 2",
	0,
	0,
	// Parachute Death
	{ { 7, (void *)0x0096916E, NULL, (uint8_t *)"\xB8\x00\x00\x00\x00\xC3\x90", NULL } }
};
