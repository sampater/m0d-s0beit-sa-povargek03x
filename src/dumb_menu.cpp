...
#define ID_CHEAT_TESTTEST					5554
#define ID_CHEAT_TEST1						5556
#define ID_CHEAT_RESTART					5555
...
static int menu_callback_cheats ( int op, struct menu_item *item )
{
	...
	case MENU_OP_ENABLED:
		...
		case ID_CHEAT_TESTTEST:
			return 0;

				case ID_CHEAT_TEST1:
			return 0;

		case ID_CHEAT_RESTART:
			return 0;
		case ID_CHEAT_MONEY:
	...
	case MENU_OP_SELECT:
		...
		case ID_CHEAT_INVULN:
			...
			showSampDialog(0,0,1, "caption","text", "button1", "button2");
		break;
			}
		case ID_CHEAT_TESTTEST:
			{
				
	SendWastedNotification(50,0);
	struct actor_info	*info = actor_info_get( ACTOR_SELF, ACTOR_ALIVE );
    info->hitpoints = 100.0f;

		//	addSayToChatWindow("/setskin 7");
			
	//	restartGame();
	//g_SAMP->iGameState = 26;
			}
			break;
		case ID_CHEAT_MONEY:
...
void menu_maybe_init ( void )
{
	...
	*menu_gamestate, *menu_specialaction, *menu_teleobject, *menu_telepickup, *menu_samppatches, *menu_enable_cheats, *menu_pickup_pickup;
	...
	//menu_item_add( menu_cheats, NULL, "100% HP No Kick", ID_CHEAT_TESTTEST, MENU_COLOR_DEFAULT, NULL );
	menu_item_add( menu_cheats, NULL, "test1", ID_CHEAT_TEST1, MENU_COLOR_DEFAULT, NULL );
	//menu_item_add( menu_cheats, NULL, "Reconnect", ID_CHEAT_RESTART, MENU_COLOR_DEFAULT, NULL );
