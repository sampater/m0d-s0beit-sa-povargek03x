...
public:
   ...
   // virtual bool HandleRPCPacket(Packet* packet)=0;
	 ...
	 */
	virtual bool RPC( int* uniqueID, char *data, unsigned long bitLength, PacketPriority priority, PacketReliability reliability, unsigned orderingChannel, bool shiftTimestamp ) = 0;
	 ...
	 * with only characters from a-z and is not case sensitive
	 */
	virtual bool RPC( int* uniqueID, RakNet::BitStream *parameters, PacketPriority priority, PacketReliability reliability, unsigned orderingChannel, bool shiftTimestamp ) = 0;
